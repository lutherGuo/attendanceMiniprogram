<template>
<uni-shadow-root class="vant-swipe-cell-index"><view class="van-swipe-cell" data-key="cell" @click.stop.prevent="onClick" @touchstart="startDrag" @touchmove.stop.prevent="onDrag" @touchend.stop.prevent="endDrag" @touchcancel.stop.prevent="endDrag">
